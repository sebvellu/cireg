#' IM-OLS Based Shin (1994) Cointegration Test
#'
#' Performs an IM-OLS based Shin (1994) Cointegration Test (CT), provided 
#' (implicitly) by Wagner and Wied (2017), extended to the cointegrating 
#' multivariate polynomial regressions (CPR) setting by Veldhuis and 
#' Wagner (2026)
#' 
...
shinimcmprtest <- function(
    ...
    crit <- getshinimcmprqntl(1 - sigl, zpow, zadd, smpl, simu, tolr)
    rjct <- (stat > crit)
